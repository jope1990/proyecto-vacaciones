    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-heading clearfix">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a id="exportbutton">Exportar a excel</a></li>
                            </ul>
                        </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-md-7">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p id="estadoid">{{ MyHelper::stateWorker($worker->state)}}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p id="celularid">{{$worker->cellphone}}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <p id="fechaingresoid">{{$worker->date_in}}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <p id="puestoid">{{$worker->position}}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <p id="areaid">{{$worker->area->name}}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table class="table" id="vacationsid">
                        <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Fecha Inicio</th>
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <table class="table" id="permissionsid">
                        <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Fecha Inicio</th>
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <table class="table" id="compensacionsid">
                        <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Fecha Inicio</th>
...
function exportToExcel() {
  /* original data */
  var filename = $('#nombreid').text().replace(/ /gi, "")+"Vacations.xlsx";
  var data = [];
  data.push(['DATOS DEL TRABAJADOR']);
  setWorkerData(data);
  addBlankRows(data, 2);
  data.push(['VACACIONES']);
  loadData(getTableData('vacationsid'),data);
  addBlankRows(data, 2);
  data.push(['PERMISOS']);
  loadData(getTableData('permissionsid'),data);
  addBlankRows(data, 2);
  data.push(['COMPENSACION']);
  loadData(getTableData('compensacionsid'),data);


  var ws_name = "ReporteVacaciones";

  var wb = XLSX.utils.book_new(),
    ws = XLSX.utils.aoa_to_sheet(data);
  wt = XLSX.utils.aoa_to_sheet(data);
...
function setWorkerData(data) {
  data.push(["Estado", $('#estadoid').text()]);
  data.push(["Nombre", $('#nombreid').text()]);
  data.push(["CI", $('#ciid').text()]);
  data.push(["Celular", $('#celularid').text()]);
  data.push(["Email", $('#emailid').text()]);
  data.push(["Fecha Ingreso", $('#fechaingresoid').text()]);
  data.push(["Puesto", $('#puestoid').text()]);
  data.push(["Area", $('#areaid').text()]);
};

function addBlankRows(data, num) {
  for (let i = 0; i < num; i++) {
    data.push([]);
  }
}
...
function getTableData(elementId) {
  var myTab = document.getElementById(elementId);
  var dataTable = [];
  ...
  for (i = 0; i < myTab.rows.length; i++) {
    ...
    for (var j = 0; j < objCells.length; j++) {
      dataRow.push(objCells.item(j).innerHTML);
    }
...
function loadData(fromArray, toArray) {
